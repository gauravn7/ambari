...
.controller('ViewsEditCtrl',
 ['$scope', '$routeParams' , 'Cluster', 'View','RemoteCluster' , 'Alert', 'PermissionLoader', 'PermissionSaver', 'ConfirmationModal', '$location', 'UnsavedDialog', '$translate', function($scope, $routeParams, Cluster, View,RemoteCluster, Alert, PermissionLoader, PermissionSaver, ConfirmationModal, $location, UnsavedDialog, $translate) {
  ...
  function initCtrlVariables(instance) {
    if(instance.ViewInstanceInfo.ambari_managed) {
      ...
      $scope.remoteCluster = instance.VieeInstanceInfo.cluster_handle;
    }
