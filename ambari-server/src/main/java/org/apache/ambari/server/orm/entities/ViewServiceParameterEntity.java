 ...
 */
@javax.persistence.IdClass(ViewServiceParameterEntityPK.class)
...
public class ViewServiceParameterEntity {
   ...
   * Set the view name.
   *
   * @param viewServiceName  the view name
   */
   ...
   */
  public ViewServiceEntity getViewServiceEntity() {
    return viewservice;
  }
   ...
   */
  public void setViewServiceEntity(ViewServiceEntity view) {
